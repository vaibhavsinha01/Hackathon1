...
from sklearn.metrics import accuracy_score, precision_score, recall_score, classification_report, confusion_matrix, f1_score,roc_curve,roc_auc_score
...
class Model:
    ...
    def plot_roc_auc_score(self):
        ...
        plt.legend()
        plt.savefig(os.path.join(r'C:\Users\Vaibhav\Desktop\hackathon2\data\plot', 'roc_auc_curve.png'))
        plt.close()
